(function(ionic) {
  ...
  var SwipeableCardView = ionic.views.View.inherit({
    ...
    isUnderThreshold: function() {
      //return true;
      console.log('isUnderThreshold!!!' + Math.abs(this.thresholdAmount));
      console.log('isUnderThresholdYYYY!!!' + Math.abs(this.thresholdAmountY));
      return (Math.abs(this.thresholdAmount) < 0.4 && Math.abs(this.thresholdAmountY) < 0.4);
    },
    /**
    ...
    transitionOut: function(e) {
      var self = this;
      console.log('transitionOut!!!' + this.isUnderThreshold());
